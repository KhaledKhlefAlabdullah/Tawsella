...
class OurServiceController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return api_response(errors: [$e->getMessage()], message: 'Error retrieving services', code: 500);
        }
    }
    ...
    public function store(ServicesRequest $request)
    {
        try {
            ...
            return api_response(data: $service, message: 'Service created successfully');
        } catch (Exception $e) {
            // Return an error API response if an exception occurs during creation
            return api_response(errors: $e->getMessage(), message: 'Error creating service', code: 500);
        }
    }
    ...
    public function update(ServicesRequest $request, OurService $service)
    {
        try {
            ...
            return api_response(errors: $e->getMessage(), message: 'Error updating service', code: 500);
        }
    }
    ...
    {
        try {
            // Remove associated files (logo and image)
            ...
            return api_response(errors: $e->getMessage(), message: 'Error deleting service', code: 500);
        }
    }
}
