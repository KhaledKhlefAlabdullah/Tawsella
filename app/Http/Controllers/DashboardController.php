...
class DashboardController extends Controller
{
    public function index()
    {
        try {
            ...
            foreach ($taxiMovements as $taxiMovement) {
                $taxiMovement['drivers'] = $drivers;
            }



            return view('dashboard', compact('taxiMovements'));
        } catch (Exception $e) {
