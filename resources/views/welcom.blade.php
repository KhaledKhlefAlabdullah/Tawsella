...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>StarTaxi</span></a></h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            ...
            <h2> نحن في شركة ستارتكسي نقدم خدمات التنقل الخاص داخل المناطق المحررة على مدار الساعة بلا توقف </h2>
        ...
        <div class="row">
          ...
          <div
            ...
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
              ...
              <p class="description"> يلتزم سائقينا بجميع القواعد والتعليمات المرورية التي تتناسب مع جميع الاعمار و
            ...
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
              ...
              <p class="description">نحن نقدم عدد من العروض و الهدايا خلال كل فترة من الزمن ليكون عملاءنا سعداء</p>
            </div>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
              <div class="icon"><i class="bx bx-atom"></i></div>
              <h4 class="title"><a href="">أوقات الخدمة</a></h4>
              <p class="description"> نحن متوفرون دائما ليلا و نهارا على مدار الساعة فقط اطلب سيارتك وسنصل اليك في اي
                وقت كان </p>
            </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-4" data-aos="fade-up">
            ...
            <p class="fst-italic">
              يصلنا طلبك من خلال التطبيق يتضمن مجموعة من البيانات التي تساعدنا في معالجة طلبك وارسال سائق اليك
            </p>
            <ul>
              <li><i class="bi bi-check"></i> اختر عنوان انطلاق واضح لسرعة وصول السائق اليك .</li>
              <li><i class="bi bi-check"></i> اختر الوجهة التي تريد الانطلاق اليها من اجل ان يتم اريال اليك السيارة
                الاكثر راحة.</li>
              <li><i class="bi bi-check"></i> اختر الجنس بشكل صحيح لضمان ارسال اليك سائق او سائقة.</li>
              <li><i class="bi bi-check"></i> اختر ارسال الموقع الدقيق ليصل اليك السائق بسرعة و سهولة.</li>
            </ul>
            <p>
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            ...
            <p>
              معالجة الطلب تكون في مقر الشركة حيث يتم التحقق من مكان تواجدك و معالجة البيانات التي قد ادخلتها وارسال
              السائق اليك
            </p>
            <p>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="assets/img/driver.png" class="img-fluid" alt=""></div>
          ...
          <ul>
            ...
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2"
                class="collapsed"> هل لديكم تطبيق من اجل طلب السيارة عن طريق الجوال؟ <i
                  class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <p>
                  نعم لدينا تطبيق من اجل طلب السيارات من الشركة عن طريق الجوال وهذا رابط المنصة لتحميل التطبيق
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3"
                class="collapsed"> هل لديكم سيارات من اجل استأجارها لمدة زمنية محددة؟ <i
                  class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                <p>
                  نعم لدينا ثلاث انواع من السيارات المستعدة من اجل الاجار لمدة زمنية محدد يمكنك التواصل معنا من اجل
                  الاستفسار اكثر
                </p>
              </div>
            </li>
