        ...
        <tr>
            <td class="esd-email-paddings" valign="top">
                                ...
                                <tr>
                                    <td class="esd-structure" align="left" esd-custom-block-id="839711">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p0r esd-container-frame" width="510" valign="top"
                                                    align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-banner"
                                                                style="position: relative;" esdev-config="h1"><a
                                                                    target="_blank"><img
                                                                        class="adapt-img esdev-stretch-width esdev-banner-rendered"
                                                                        src="https://tlr.stripocdn.email/content/guids/bannerImgGuid/images/image16754305136317786.png"
                                                                        alt title width="510"
                                                                        style="display: block;"></a>
                                                                <esd-stored-config-block style="display: none;">
                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                   cellspacing="0" width="510" style="border-radius: 0 0 50px 50px">
                                <tbody>
                                <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-block-text">
                                                                <h1 style="color: #5d541d;">Please confirm<br>your email
                                                                    address</h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="esd-block-text es-p40t es-p40b">
                                                                <h3>Thanks for joining Brandindoor!</h3>
                                                                <p><br></p>
                                                                <p>To finish signing up, please confirm your email
                                                            ...
                                                            <td align="center" class="esd-block-button">
                                                                <!--[if mso]><a href="https://viewstripo.email"
                                                                    ...
                                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                 ...
                                                                                 style="height:49px; v-text-anchor:middle; width:254px"
                                                                                 arcsize="50%" stroke="f"
                                                                                 fillcolor="#8928c6">
                                                                        <w:anchorlock></w:anchorlock>
                                                                        <center
                                                                            style='color:#ffffff; font-family:Poppins, sans-serif; font-size:16px; font-weight:400; line-height:16px;  mso-text-raise:1px'>
                                                                ...
                                                                <!--[if !mso]><!-- --><span
                                                                    ...
                                                                    style="background: #8928c6;"><a
                                                                        href="https://viewstripo.email"
                                                                        class="es-button" target="_blank"
                                                                        style="background: #8928c6; mso-border-alt: 10px solid  #8928c6">Confirm email address</a></span>
                                                                <!--<![endif]-->
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                            ...
                                            <tr>
                                                <td width="470" align="left" class="esd-container-frame">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-block-text">
                                                                <p style="font-size: 14px;">Thanks,<br>Brandindoor Team!&nbsp;
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table bgcolor="#ffffff" class="es-footer-body" align="center" cellpadding="0"
                                   cellspacing="0" width="510" style="border-radius: 50px">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p20t es-p20b es-p20r es-p20l" align="left"
                                        esd-custom-block-id="839717">
                                        <!--[if mso]>
                                            ...
                                            <tr>
                                                <td width="225" class="es-m-p20b esd-container-frame" align="left">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="left" class="esd-block-image es-m-txt-c"
                                                                style="font-size: 0px;"><a target="_blank"
                                                                                           href="https://viewstripo.email"><img
                                                                        src="https://tlr.stripocdn.email/content/guids/CABINET_1bfc4ac6dddc4ae38edeae5cbef32bf9ff4e576d845736df126fd766dd798e9a/images/group_4076195_Ni6.png"
                                                                        alt="Logo" style="display: block;" height="30"
                                                                        title="Logo"></a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td width="225" align="left" class="esd-container-frame">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="right" class="esd-block-social es-p5t es-m-txt-c"
                                                                style="font-size:0">
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="center" valign="top" class="es-p10r">
                                                                            <a target="_blank"
                                                                               href="https://viewstripo.email"><img
                                                                                    src="https://tlr.stripocdn.email/content/assets/img/social-icons/circle-white/x-circle-white.png"
                                                                                    alt="Х" title="Х" height="24"></a>
                                                                        </td>
                                                                        <td align="center" valign="top" class="es-p10r">
                                                                            <a target="_blank"
                                                                               href="https://viewstripo.email"><img
                ...
                <table cellpadding="0" cellspacing="0" class="es-content" align="center">
                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="510"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                style="font-size:0"><a target="_blank"
                                                                                       href="https://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=confirm_email_2&utm_content=finish_registration"><img
                                                                        src="https://tlr.stripocdn.email/content/guids/CABINET_09023af45624943febfa123c229a060b/images/7911561025989373.png"
                                                                        alt width="125" style="display: block;"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
