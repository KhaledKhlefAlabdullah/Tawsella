        ...
        <tr>
            <td valign="top" style="padding:0;Margin:0">
                <table cellpadding="0" cellspacing="0" align="center" class="es-header" role="none"
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#fad939" align="center" cellpadding="0" cellspacing="0"
                ...
                <table cellspacing="0" cellpadding="0" align="center" class="es-content" role="none"
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table cellspacing="0" cellpadding="0" align="center" bgcolor="#FAD939"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;position:relative"><img
                                                                        src="https://epurhb.stripocdn.email/content/guids/bannerImgGuid/images/image17272952317805427.png"
                                                                        alt="" title="" width="510" height="324"
                                                                        class="adapt-img"
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0"
                                   class="es-content-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FAD939;border-radius:0 0 50px 50px;width:510px"
                                   role="none">
                                <tr>
                                    <td align="left" style="padding:0;Margin:0;padding-right:20px;padding-left:20px">
                                        <table cellpadding="0" cellspacing="0" width="100%" role="none"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><h1
                                                                        style="Margin:0;font-family:Ciro, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:38px;font-style:normal;font-weight:bold;line-height:45.6px;color:#5d541d">
                                                                    رجاء قم بتأكيد حسابك<br> لمتابعة استخدام التطبيق
                                                                </h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:40px;padding-bottom:40px">
                                                                <h3 style="Margin:0;font-family:Ciro, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#5D541D">
                                                                    هذا هو رمز التأكيد الخاص بك:
                                                                    <span>{{$mail_message}}</span></h3>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Ciro, sans-serif;line-height:27px;letter-spacing:0;color:#5D541D;font-size:18px">
                                                                    <br></p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Ciro, sans-serif;line-height:27px;letter-spacing:0;color:#5D541D;font-size:18px">
                                                                    لإكمال عملية التسجيل، يرجى تأكيد عنوان بريدك
                                                                    الإلكتروني. يضمن ذلك أن لدينا البريد الإلكتروني
                                                                    الصحيح في حال احتجنا للتواصل معك.</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="left"
                                        style="Margin:0;padding-right:20px;padding-left:20px;padding-bottom:40px;padding-top:20px">
                                        <table cellpadding="0" cellspacing="0" width="100%" role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
